...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Hallo - Mobile and Laptop Sales</title>
        ...
        <div class="container-fluid fixed-top">
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="index.html" class="navbar-brand"><h1 class="text-primary display-6">Hallo</h1></a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="{{ route('customerShop') }}" class="nav-item nav-link">Shop</a>
                            ...
                            <form method="POST" action="{{ url('/logout') }}">
                                ...
                                <button type="submit" value="logout" class="btn btn-primary text-white mt-1">logout</button>
                            </form>
                        </div>
    ...
    {{-- Jquery for the cart system - cart value affecting the total price --}}
    @yield('JqContent')
