                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control @error('name')  is-invalid @enderror" id="" value="{{ old('name') }}" placeholder="Drinks...">
                                            @error('name')
                                                <small class=" invalid-feedback">{{ $message }}</small>
                                            @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="categoryId" class="form-control @error('categoryId')  is-invalid @enderror" id="" >
                                            ...
                                            @foreach ($categoryData as $c )
                                                <option value="{{$c->id}}" @if ( old('categoryId') == $c->id ) selected @endif>{{ $c->name }}</option>
                                            @endforeach
